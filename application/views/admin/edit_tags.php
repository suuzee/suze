        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
	                    <div class="col-lg-12">
	                    	<form action="admin/do_edit_tags/<?php echo $tag -> tag_id;?>" method="post" class="form-horizontal">
                                <div class="control-group col-lg-8">
                                    <label>标签名称</label>
                                    <input class="form-control" name="tag_name" value="<?php echo $tag -> tag_name;?>" >
                                </div>
                                <input type="submit" class="btn btn-default" id="submit" name="add_tags" value="修改标签" />
                            </form>
	                    </div>
                	</div>
                    <!-- /.row -->
